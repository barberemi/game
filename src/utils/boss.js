export const boss = {
  ...
  items: [
    ...
    {id: 8, name: "Chaussures d'or", image: "https://wow.zamimg.com/images/wow/icons/large/inv_boots_cloth_05.jpg", cost: 5000, level: 50, type: "shoes", rarity: "legendary", characteristics: [
        {amount: 50, characteristic: {name: "Vie"}},
      ]},
    {id: 9, name: "Épée d'or", image: "https://www.gameuionweb.com/zelda-botw/items/weapons/BotW_Ancient_Short_Sword_Icon.png", cost: 5500, level: 55, type: "weapon", rarity: "legendary", characteristics: [
        {amount: 55, characteristic: {name: "Vie"}},
        {amount: 100, characteristic: {name: "Force"}},
      ]},
    {id: 10, name: "Claymore de chevalier", image: "https://www.gameuionweb.com/zelda-botw/items/weapons/BotW_Royal_Claymore_Icon.png", cost: 4500, level: 45, type: "weapon", rarity: "legendary", characteristics: [
        {amount: 35, characteristic: {name: "Vie"}},
        {amount: 30, characteristic: {name: "Force"}},
      ]},
    {id: 11, name: "Bâton divin", image: "https://www.gameuionweb.com/zelda-botw/items/weapons/BotW_Tree_Branch_Icon.png", cost: 4500, level: 45, type: "weapon", rarity: "epic", characteristics: [
