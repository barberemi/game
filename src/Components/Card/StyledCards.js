      ...
      <>
        {this.state.objects && (
          <>
            ...
            {this.props.displayLightDarkButton && (
              <LightDarkButton
                onClick={(type) => this.props.onClickLightDarkButton(type)}
              />
            )}
...
StyledCards.propTypes = {
  displayLightDarkButton: PropTypes.bool,
  type: PropTypes.string,
  isDark: PropTypes.bool,
  onClick: PropTypes.func,
  selectedId: PropTypes.number,
  onClickLightDarkButton: PropTypes.func
}
